 ...
 <jsp:include page="include/head.jsp"></jsp:include>
    ...
    <div class="content-wrap"  id="match-item-list">
        <div class="container">
            <div class="row">
                <div class="p-content">
                    <h1 id="a" class="title-intent title-pages mobile-marginlr-15"><i class="fa fa-futbol-o" aria-hidden="true"></i>Danh sách các đội bóng</h1>
                    <div class="form-group row mobile-marginlr-15">
                        <form method="get" action="Doibong">
